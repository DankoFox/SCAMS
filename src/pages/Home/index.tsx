		...
		switch (userType) {
			case "lecturer":
				return {
					...
					subDescription:
						"Ho Chi Minh City University of Technology has many buildings in a large area. Each building has meeting rooms and classrooms with qualified facilities.",
					buttons: [
			...
			default:
				return {
					...
					subDescription:
						"Use your school account to log in and enjoy all the convenient services of the Smart Campus System.",
